feature 'Listing Purchase Orders for the hub' do
  ...
  let(:purchase_orders_with_recent_updated_date) do
    create_list(:purchase_order, 15, :with_line_items_with_barcode, :with_grn_events, :with_recent_updated_date)
  end

  let(:purchase_orders_with_fixed_date) do
    create_list(:purchase_order, 10, :with_line_items_with_barcode, :with_grn_events, :with_fixed_updated_date)
  end

  let(:purchase_orders_without_date) do
    create_list(:purchase_order, 5, :with_line_items_with_barcode, :with_grn_events, :without_updated_date)
  end
end
