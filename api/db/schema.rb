...
ActiveRecord::Schema.define(version: 20161018091052) do
  ...
  create_table "over_deliveries", force: :cascade do |t|
    t.string   "sku",        limit: 255
    t.integer  "quantity",   limit: 4
    t.integer  "user_id",    limit: 4
    t.string   "grn",        limit: 255
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
  end

  add_index "over_deliveries", ["sku"], name: "index_over_deliveries_on_sku", using: :btree
  ...
  create_table "purchase_orders", force: :cascade do |t|
    ...
    t.integer  "sku_id",                      limit: 4
    t.string   "orderTool_SDcolor",           limit: 255
    t.integer  "po_chunk_number",             limit: 4
  end
