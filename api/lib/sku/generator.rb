class Sku::Generator
  ...
  def generate_new_sku
    ...
    product_option = LanguageProductOption.create(product_option_attrs(product, option, element))
    product_category = LanguageProductCategory.create(product_category_attrs(category))
